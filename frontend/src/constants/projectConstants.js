export const PROJECT_LIST_REQUEST = 'PROJECT_REQUEST';
export const PROJECT_LIST_SUCCESS = 'PROJECT_SUCCESS';
export const PROJECT_LIST_FAIL = 'PROJECT_FAIL';
export const PROJECT_LIST_RESET = 'PROJECT_RESET';
...
export const PROJECT_UPDATE_SUCCESS = 'PROJECT_UPDATE_SUCESS';
